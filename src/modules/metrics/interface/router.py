...
from src.modules.metrics.interface.deps import (
    get_accessible_uc, get_dashboard_uc, get_projections_uc, get_report_uc, get_user_repo,
)
...
async def team(
    ...
    team_users: list[dict[str, object]] = [{"id": u.id, "name": u.name, "shop_role": u.shop_role} for u in team_users_domain]
